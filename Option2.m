...
for n=1:6
    variable_times=variable_times+1;
    [SU_sim_L(:,variable_times),SE_sim_L(:,variable_times)]=success_probability_sim(Lambda_V,Lambda_U,Lambda_R,n);
    variable(variable_times)=n;
end

function [SU_sim_L,SE_sim_L]=success_probability_sim(Lambda_V,Lambda_U,Lambda_R,n)
R_c=1;
beta_c=2^R_c-1;
beta_f=-20;
beta_f=10^(beta_f/10);
...
for times=1:times_total
    ...
    if SINR_ACK_1<beta_f && SINR_ACK_2<beta_f && SINR_ACK_3<beta_f && SINR_ACK_4<beta_f && SINR_ACK_5<beta_f && SINR_ACK_6<beta_f && SINR_ACK_7<beta_f && SINR_ACK_8<beta_f && SINR_ACK_9<beta_f && L>=10
        ...
        if SINR_VAM_10>=beta_c/10 && SINR_VAM_1<beta_c && SINR_VAM_2<beta_c/2 && SINR_VAM_3<beta_c/3 && SINR_VAM_4<beta_c/4 && SINR_VAM_5<beta_c/5 && SINR_VAM_6<beta_c/6 && SINR_VAM_7<beta_c/7 && SINR_VAM_8<beta_c/8 && SINR_VAM_9<beta_c/9
            ...
            SINR_ACK_10=Monte_Carlo_NACK_sim(Lambda_V,Lambda_U,Lambda_R,xi);
        end
    end
    if SINR_ACK_1<beta_f && SINR_ACK_2<beta_f && SINR_ACK_3<beta_f && SINR_ACK_4<beta_f && SINR_ACK_5<beta_f && SINR_ACK_6<beta_f && SINR_ACK_7<beta_f && SINR_ACK_8<beta_f && SINR_ACK_9<beta_f && SINR_ACK_10<beta_f && L>=11
        time_round_10=time_round_10-1;
    end
    ...
    disp(['Lambda_V=',num2str(Lambda_V),'; Lambda_U=',num2str(Lambda_U),'; Lambda_R=',num2str(Lambda_R),'; n=',num2str(n),'; simulation_times:',num2str(times)]);
end
...
SU_sim_L=[S_sim_L_1;S_sim_L_2;S_sim_L_3;S_sim_L_4;S_sim_L_5;S_sim_L_6;S_sim_L_7;S_sim_L_8;S_sim_L_9;S_sim_L_10];
...
SE_sim_L=[SE_sim_1;SE_sim_2;SE_sim_3;SE_sim_4;SE_sim_5;SE_sim_6;SE_sim_7;SE_sim_8;SE_sim_9;SE_sim_10];
end
